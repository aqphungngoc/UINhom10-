package com.icebear.speechnote.voicerecorder;
...
public class ActivityRecorder extends Activity implements VoiceView.OnRecordListener{

    private static final String TAG = ActivityRecorder.class.getName();
    ...
    public void onRecordStart() {
        ...
        try {
            ...
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    float radius = (float) Math.log10(Math.max(1, mMediaRecorder.getMaxAmplitude() - 500)) * ScreenUtils.dp2px(ActivityRecorder.this, 20);
